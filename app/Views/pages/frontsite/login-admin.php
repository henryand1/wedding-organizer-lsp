...
<div class="container mb-5 d-flex justify-content-center">
  <div class="login card" style="max-width: 75%;">
    <div class="textlogin card-body mt-3 mb-5 ms-5 me-5" url="">
      <h2 class="card-title fw-bold fs-lg-4 fs-5 text-center" style="color:#F5F5F5">LOGIN ADMIN</h2>
      <p class="card-subtitle mb-2 small" style="color:#F5F5F5">========================================</p>
      <form method="POST" action="loginadminn">
        <div class="mb-3 mt-4">
          <label for="email" class="form-label fw-semibold" style="color:#F5F5F5">Username</label>
          <input class="usershape form-control <?= ($validation->hasError('email')) ? 'is-invalid' : ''; ?>" id="email" value="<?= old('email', isset($input['email']) ? $input['email'] : ''); ?>" aria-describedby="emailHelp" placeholder="Masukkan Username" name="email">
